  ...
  stages: [
    {
      ...
      instructions: [
        "Write exactly two JSON artifacts: one with stage=\"protocol\" and one with stage=\"queries\". Use the canonical field names below; do not replace them with aliases such as databasePlan, searchableConcepts, selectedQueries[].string, or selectedQueries[].databases.",
        "",
        "protocol fields:",
        "- stage: must be \"protocol\".",
        "- question: the scoped review question.",
        "- databases: executable database ids or names as an array, for example [\"openalex\", \"semantic-scholar\", \"crossref\", \"arxiv\"].",
        "- criteria: inclusion/exclusion rules for screening. Include at least include/exclude arrays or equivalent explicit rules.",
        "- conceptDefinition: short definition of the review scope.",
        "",
        "queries fields:",
        "- stage: must be \"queries\".",
        "- researchQuestion: same scoped review question.",
        "- conceptDefinition: object with term, definition, and scope fields.",
        "- concepts: array of structured concepts. Each concept should use name or label plus synonyms/terms/searchTerms. Put concept grounding here, not only in prose.",
        "- coreTerms: array of at least three core searchable terms for the macro topic.",
        "- topicExpansion: object with macroConcept, macroTerms, facets, and excludeTerms. Facets should describe subtopics and their terms.",
        "- selectedQueries: array of executable query objects. Each item must have database and query. Use query, not string. Use one database per item, not a databases array.",
        "- alternativeQueries: optional backup queries with the same database/query shape.",
        "",
        "Minimal example:",
        "{\"stage\":\"protocol\",\"question\":\"AI4S development status\",\"databases\":[\"openalex\",\"semantic-scholar\",\"arxiv\"],\"criteria\":{\"include\":[\"AI methods applied to scientific discovery\"],\"exclude\":[\"generic AI without science application\"]},\"conceptDefinition\":\"AI for Science uses AI/ML to accelerate scientific discovery.\"}",
        "{\"stage\":\"queries\",\"researchQuestion\":\"AI4S development status\",\"conceptDefinition\":{\"term\":\"AI for Science\",\"definition\":\"AI/ML methods used to accelerate scientific discovery.\",\"scope\":[\"AI4S\",\"scientific discovery\",\"foundation models for science\"]},\"concepts\":[{\"name\":\"AI for Science\",\"synonyms\":[\"AI4S\",\"AI for scientific discovery\"],\"terms\":[\"scientific machine learning\"]}],\"coreTerms\":[\"AI4S\",\"AI for Science\",\"scientific machine learning\"],\"topicExpansion\":{\"stage\":\"topic_expansion\",\"macroConcept\":\"AI for Science\",\"macroTerms\":[\"AI4S\",\"AI for Science\"],\"facets\":[{\"id\":\"foundation_models\",\"label\":\"Foundation models for science\",\"terms\":[\"foundation models for science\"],\"requiredTerms\":[\"foundation models\"]}],\"excludeTerms\":[]},\"selectedQueries\":[{\"database\":\"openalex\",\"query\":\"(\\\"AI for Science\\\" OR AI4S) AND (review OR survey OR trends)\",\"rationale\":\"High-level AI4S review query.\"}]}"
      ].join("\n"),
